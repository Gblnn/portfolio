          ...
          >
            ...
            <div className="project-container" style={{ marginTop: "1rem" }}>
              <Project
                ...
                desc="A company landing page for Sohar Star United LLC"
              />

              <Project
                img="/wo-page.png"
                title="Wahat Oman Industrial Gases"
                link="https://wahatoman.co"
                desc="A company landing page for Wahat Oman Industrial Gases LLC"
              />
              ...
              <Project
                ...
                desc="Coffee is a textual social media app written in React and TypeScript"
              />
              ...
              <Project
                ...
                desc="A responsive dashboard design written in React and TypeScript"
              />

              <Project
                img="/blaze-page.png"
                title="Blaze"
                desc="An online store design written in React and TypeScript with search filter"
              />
            </div>
          </div>
          ...
          <div className="page">
            ...
            >
              ...
              <p className="desc" style={{ textAlign: "center" }}>
                ...
                just want to say hi, my inbox is always open. So feel free to
